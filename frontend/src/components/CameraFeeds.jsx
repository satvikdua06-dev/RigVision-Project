      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {[0, 1, 2].map(camId => (
          <div key={camId} style={{ position: 'relative' }}>
            <img 
              src={`http://${host}:8000/api/video/mjpeg/${camId}`} 
              alt={`Camera ${camId}`} 
              style={{ width: 320, height: 180, borderRadius: 6, border: '1px solid #2a4a5a', objectFit: 'cover' }} 
              onError={(e) => {
            ...
            />
            <div style={{
              display: 'none', width: 320, height: 180, borderRadius: 6, border: '1px solid rgba(255,255,255,0.1)',
