"""
BoT-SORT — Bag of Tricks for SORT multi-object tracker.

Based on: https://github.com/NirAharon/BoT-SORT
...
Changes from upstream:
  ...
  - Removed unused matplotlib import (L2)
  - Fixed wrong xywh docstring (L3)
  - Replaced deprecated np.float with float (numpy compat)
"""
...
# Maximum number of removed tracks to keep in memory.
# Prevents unbounded growth during 24/7 rig monitoring.
...
class STrack(BaseTrack):
    ...
    def update_features(self, feat): #to update the tracklet of the person this should include teh new apperance vector we have recieved 
        ...
        if norm < 1e-6:
            return
        # H1: Don't mutate the caller's array — create a copy
        feat = feat / norm
        self.curr_feat = feat
...
class BoTSORT(object):
    ...
    def update(self, output_results, img):
        ...
        # M2: Prevent unbounded growth of removed_stracks during long-running sessions
        ...
        # M3: Only return confirmed (activated) tracks to prevent phantom single-frame IDs
