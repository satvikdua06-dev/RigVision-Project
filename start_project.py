...
processes_to_run = [
    ...
    {
        "name": "Risk-Engine",
        "command": ["python", "-m", "risk_engine.compound_risk"],
        "cwd": ".",
        "color": RED,
        "delay_before": 1.0,
    },
    {
        "name": "Pattern-Intel",
        "command": ["python", "-m", "knowledge.agent_layer.pattern_intelligence"],
        "cwd": ".",
        "color": MAGENTA,
        "delay_before": 2.0,
    },
    {
        ...
        "command": ["python", "-m", "knowledge.agent_layer.compliance_audit"],
        "cwd": ".",
        "color": YELLOW,
        "delay_before": 1.0,
    },
    {
        "name": "Pipeline",
        "command": ["python", "pipeline.py", "--mode", "video", "--cameras", "test0.mp4", "test1.mp4", "--video-offsets" , "1=22"],
        "cwd": "cv",
        "color": YELLOW,
        "delay_before": 1.0,
    },
